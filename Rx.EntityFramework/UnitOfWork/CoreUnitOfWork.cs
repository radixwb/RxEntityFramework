using Rx.EntityFramework.Attributes;
using Rx.EntityFramework.Internal;
using System;
...
namespace Rx.EntityFramework
{
    public abstract class CoreUnitOfWork : ICoreUnitOfWork, IDisposable
    {
        ...
        private void LogAudit(DbEntityEntry entityEntry)
        {
        ...
        private void SetContextRepository(IDbContext context, IRepositoryProvider repositoryProvider)
        {
            ...
            DataUtility.DbConnectionString = Context.Database.Connection.ConnectionString;
        }
